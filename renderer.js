...
function createUIEventListeners(){
    document.getElementById("positionX").addEventListener("input", updateTransformFromUI)
    document.getElementById("positionY").addEventListener("input", updateTransformFromUI)
    document.getElementById("positionZ").addEventListener("input", updateTransformFromUI)
    document.getElementById("rotationX").addEventListener("input", updateTransformFromUI)
    document.getElementById("rotationY").addEventListener("input", updateTransformFromUI)
    document.getElementById("rotationZ").addEventListener("input", updateTransformFromUI)
    document.getElementById("scaleX").addEventListener("input", updateTransformFromUI)
    document.getElementById("scaleY").addEventListener("input", updateTransformFromUI)
    document.getElementById("scaleZ").addEventListener("input", updateTransformFromUI)
}

function updateTransformFromUI(){
    //transformMatrix = mat4.perspective(gl.canvas.clientWidth, gl.canvas.clientHeight, 400);
    transformMatrix = mat4.perspective(90, aspectRatio, zNear, zFar)
    transformMatrix = mat4.translate(transformMatrix, document.getElementById("positionX").value, document.getElementById("positionY").value, document.getElementById("positionZ").value)
    
    transformMatrix = mat4.rotateX(transformMatrix, document.getElementById("rotationX").value * (Math.PI / 180))
    transformMatrix = mat4.rotateY(transformMatrix, document.getElementById("rotationY").value * (Math.PI / 180))
    transformMatrix = mat4.rotateZ(transformMatrix, document.getElementById("rotationZ").value * (Math.PI / 180))

    transformMatrix = mat4.scale(transformMatrix, document.getElementById("scaleX").value/10, document.getElementById("scaleY").value/10, document.getElementById("scaleZ").value/10)
